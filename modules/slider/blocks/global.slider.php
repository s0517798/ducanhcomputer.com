...
if( ! nv_function_exists( 'content_slider' ) )
{
	...
	function nv_block_config_slider_blocks( $module, $data_block, $lang_block )
	{
		...
		$html .= '<label class="control-label col-sm-6">' . $lang_block['group_id'] . ':</label>';
		$html .= '<div class="col-sm-9"><select name="config_group_id" class="form-control">';
		...
		$html .= '<div class="col-sm-18"><input type="text" name="config_numrow" size="5" value="' . $data_block['numrow'] . '" class="form-control"/></div>';
		$html .= '</div>';
		
		$html .= '<div class="form-group">';
		$html .= '<label class="control-label col-sm-6">' . $lang_block['widthimg'] . '</label>';
		$html .= '<div class="col-sm-18"><input type="text" name="config_widthimg" size="30" value="' . $data_block['widthimg'] . '" class="form-control"/></div>';
		$html .= '</div>';
		
		$html .= '<div class="form-group">';
		$html .= '<label class="control-label col-sm-6">' . $lang_block['heightimg'] . '</label>';
		$html .= '<div class="col-sm-18"><input type="text" name="config_heightimg" size="5" value="' . $data_block['heightimg'] . '" class="form-control"/></div>';
		$html .= '</div>';
		
		$html .= '<div class="form-group">';
		$html .= '<label class="control-label col-sm-6">' . $lang_block['readmore'] . '</label>';
		$html .= '<div class="col-sm-18"><input type="text" name="config_readmore" value="' . $data_block['readmore'] . '" class="form-control"/></div>';
		$html .= '</div>';
		
		$html .= '<div class="form-group">';
		$html .= '<label class="control-label col-sm-6">' . $lang_block['buttonstype'] . '</label>';
		$html .= '<div class="col-sm-18"><select name="config_buttonstype" class="form-control">';
		$langs = array(
			'none',
			'small',
			'large' );
