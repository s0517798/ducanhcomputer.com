...
function detail_theme($news_contents, $array_keyword, $related_new_array, $related_array, $topic_array, $content_comment)
{
    ...
    $news_contents['addtime1'] = nv_date('d/m/Y h:i:s', $news_contents['addtime']);
    $news_contents['addtime_json'] = nv_date('Y-m-d', $news_contents['addtime']);
    $news_contents['edittime_json'] = nv_date('Y-m-d', $news_contents['addtime']);
