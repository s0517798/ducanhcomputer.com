...
if( $nv_Request->isset_request( 'mod_file', 'get' ) )
{
	...
	{
		$check_alias = new NukeViet\Tar\Checkalias;
...
{
	if($mod['module_file'] == 'shops' or $mod['module_file'] == 'services' or $mod['module_file'] == 'page' or $mod['module_file'] == 'news' or $mod['module_file'] == 'store' or $mod['module_file'] == 'download' or $mod['module_file'] == 'zodiac')
	{
		$xtpl->assign( 'mod', $mod );
