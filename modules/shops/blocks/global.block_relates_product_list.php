...
if (!nv_function_exists('nv_relates_product')) {
     ...
     *
     */
    function nv_block_config_relates_blocks_list($module, $data_block, $lang_block)
    {
     ...
     *
     */
    function nv_block_config_relates_blocks_list_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
     ...
     *
     */
    function nv_relates_product_list($block_config)
    {
        ...
        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $mod_file . '/block.others_product_list.tpl')) {
        ...
        $xtpl = new XTemplate('block.others_product_list.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file);
...
if (defined('NV_SYSTEM')) {
    $content = nv_relates_product_list($block_config);
}
