...
<script type="application/ld+json">
{
  ...
  "image": "{NV_MY_DOMAIN}/{DETAIL.homeimgfile}",
  "datePublished": "{DETAIL.addtime_json}",
  "dateModified": "{DETAIL.edittime_json}",
  "author": {
    "@type": "Person",
    "name": "John Doe"
  },
   "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "{NV_MY_DOMAIN}/themes/uploads/logo.png"
    }
  },
  "description": "{DETAIL.hometext}"
}
</script>
